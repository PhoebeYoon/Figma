...
<img width="350" alt="스크린샷 2023-05-11 오전 11 13 17" ssrc="https://user-images.githubusercontent.com/66a68bd9-ad52-4d71-894d-750e71d35e41">   
...
<img width="350" alt="스크린샷 2023-05-12 오후 2 42 53" src="https://github.com/PhoebeYoon/Figma/assets/48478079/a3477622-cff5-462e-addf-0c59e7bd29e9">.   
<img width="350" alt="스크린샷 2023-05-12 오후 2 43 47" src="https://github.com/PhoebeYoon/Figma/assets/48478079/d8fbd2e0-f92f-474b-ae21-ed02d9f5dfb6">      

<img width="370" alt="스크린샷 2023-05-11 오전 11 18 30" src="https://github.com/PhoebeYoon/Figma/assets/48478079/5c5d0bcf-e188-4ede-b831-91f2396fc348">    
...
## 🍑 게슈탈트 이론 (GESTALT). 
**막스 베르트하이머 (Max Wertheimer) – “우리의 뇌는 구성 요소들을 개별적으로 보기에 앞서서 그 윤곽이나 패턴, 형태적 차이를 먼저 파악하려는 습성을 지녔다” 즉, 사람이 형태나 모양을 볼 때 인지하는 방식을 설명**
유사성의 원리, 근접성의 원리 , 공통의 원리, 연속성의 원리

- 유사성의 원리 : 색 모양, 크기가 동일한 요소들을 하나의 관계로 묶어서 보려는 경향. 유사한 형태끼리는 연관되어 보이는 원리, 생김새의 차이가 클수록 사람들은 더 빨리 대상을 구분한다
- 근접성의 원리 : 서로 이웃해 있는 요소들과 그렇지 않은 요소들을 구분하려는 경향 즉, 그룹핑이 되어 있는 요소들과 그렇지 않은 요소들을 구분하는 것으로 서로 연관되어 있는 정보들은 최대한 가깝게 배치하고 그렇지 않는 요소들은 떨어뜨려서 배치한다
...
<br />
<img width="290" alt="스크린샷 2023-05-17 오전 10 17 06" src="https://github.com/PhoebeYoon/Figma/assets/48478079/2d2c5451-d2bf-4f88-9e8f-c1c83590e491">
<img width="290" alt="스크린샷 2023-05-17 오전 10 17 15" src="https://github.com/PhoebeYoon/Figma/assets/48478079/f1638d8e-7a69-49b5-b64b-a00ac7763ded">
